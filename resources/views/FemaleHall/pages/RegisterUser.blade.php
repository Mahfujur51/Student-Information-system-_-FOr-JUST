		...
		<div class="content-wrapper">
			<div class="row">
				...
				<div class="col-sm-6 col-md-6 grid-margin">
					<div class="card">
						<div class="card-body">
							<h2 class="card-title">Register user For Female Room <span class="badge badge-info">{{$student->count()}}</span></h2>
			...
			<table id="order-listing" class="table table-striped" style="width:100%;">
              ...
              @endif</td>
					...
					<td>
						<a href="{{ route('fstudent.given.room',$students->id) }}" class="btn btn-info">Give Room</a>
					</td>
