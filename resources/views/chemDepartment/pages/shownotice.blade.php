...
<div class="container-fluid page-body-wrapper">
	<div class="row row-offcanvas row-offcanvas-right">
		...
		@include('chemDepartment.inc.sidebar')
		<!-- partial -->
			...
			<table id="order-listing" class="table table-striped" style="width:100%;">
				...
				<tr>
					...
					<td>
						...
						<a href="{{ route('chemdepartment.notice.view',$students->id) }}" class="btn btn-primary">View This Notice</a>

					</td>
					<td>
						<a href="{{ route('student.chemdepartment.notice.delete',$students->id) }}" class="btn btn-danger">Delete</a>
						<a href="{{ route('student.chemdepartment.notice.update',$students->id) }}" class="btn btn-secondary">Update</a>
					</td>
