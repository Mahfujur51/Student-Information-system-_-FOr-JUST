			...
			<table id="order-listing" class="table table-striped" style="width:100%;">
				...
				<tr>
					...
					<td>
						...
						<a href="{{ route('mktdepartment.notice.view',$students->id) }}" class="btn btn-primary">View This Notice</a>

					</td>
					<td>
						<a href="{{ route('student.mktdepartment.notice.delete',$students->id) }}" class="btn btn-danger">Delete</a>
						<a href="{{ route('student.mktdepartment.notice.update',$students->id) }}" class="btn btn-secondary">Update</a>
					</td>
