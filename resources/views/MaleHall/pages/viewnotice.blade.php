			...
			<table id="order-listing" class="table table-striped" style="width:100%;">
				...
				<tr>
					...
					<td>
						...
						<a href="{{ route('malehall.show.notice',$students->id) }}" class="btn btn-primary">View This Notice</a>

					</td>
					<td>
						<a href="{{ route('mallhall.delete',$students->id) }}" class="btn btn-danger">Delete</a>
						<a href="{{ route('malehall.update',$students->id) }}" class="btn btn-secondary">Update</a>
					</td>
