            ...
            <li class="nav-item"  class="{{ (request()->is('student/cse/profile/*')) ? 'active' : '' }}">
              ...
              <div class="collapse" id="submenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('nft.student') }}">Department Student</a>
                  </li>
          ...
          <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('nft.chairman.notice') }}">View Chairman Notice</a>
                  </li>
              ...
              <div class="collapse" id="sidebar_layouts1">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('nftdepartment.upload.notice') }}">Upload Notice for student</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('nftdepartment.show.notice') }}">View Upload Notice</a>
                  </li>
